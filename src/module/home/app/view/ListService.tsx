        ...
        <div className="mt-20 relative">
            ...
            <div className="relative z-2">
                ...
                <div className="lap:overflow-y-auto lap:scrollbar-x-dark pb-5">
                    <div className="max-tab:hidden mt-[46px] mx-auto w-[590px] lap:w-[1210px] grid grid-cols-2 lap:grid-cols-4 gap-10">
                        <div
                            className="bg-white rounded-xl p-2 pb-4 relative border border-[#F3F4F6] h-[506px] my-auto"
                        ...
                        >
                            ...
                            <div className="h-px w-full bg-[#F3F4F6] my-4" />
                            <div className="rounded-full h-12 flex-center cursor-pointer bg-[#1FAEEB] text-lg leading-6 text-[#F9FAFB] font-semibold hover:opacity-90">
                                Đăng ký
                            </div>
                        </div>
                        <div
                        ...
                        <div
                            className="bg-white rounded-xl p-2 pb-4 relative border h-[518px] border-[#2196F3]"
                            style={{ boxShadow: "0px 0px 4px 0px #00000026" }}
                        >
                            <div className="absolute w-[146px] h-[48px] rounded-full bg-white/50 left-[20px] top-[-27px] flex-center overflow-hidden shadow">
                                <div className="w-[136px] h-[40px] rounded-full bg-[#1FAEEB] flex-center gap-2">
                ...
                <div className="tab:hidden mt-8 mx-4">
                    <div
                        className="bg-white rounded-lg p-4 max-w-100 mx-auto"
                        style={{ boxShadow: "0px 0px 4px 0px #00000026" }}
                    >
